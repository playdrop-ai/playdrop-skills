...
description: "Review a Playdrop game before release or republish to judge whether the build is actually worth shipping. Use when the user needs a candid check on hook, legibility, controls, session quality, replayability, or whether listing work is justified yet."
---

# Gameplay Review

Use this skill when functional testing is not enough and the question is whether the game feels strong enough to publish.
...
- do not let listing art or marketing language hide a weak build
...
- technical correctness or multiplayer validation -> `dev-testing`
- runtime polish or feel fixes -> `game-improvement`
