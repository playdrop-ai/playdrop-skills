...
Public Playdrop skills for AI coding agents and developer workflows.
...
- `skills/playdrop`: public workflow for discovering Playdrop references, reading public documentation, using the CLI and SDK, improving listings, integrating services, and publishing creator-owned content
